 ...
 */
public class abstractClassDress {public static WebDriver driver;
    ...
    public static void openBrowser(String BrowserUrl) throws InterruptedException, IOException {
        ...
        test = report.startTest("DressSignUP", "Dress Sign Up");

        test.log(LogStatus.INFO, "navigating to dress sign up page ");
        //code below will allow me to navigate to sign up page
